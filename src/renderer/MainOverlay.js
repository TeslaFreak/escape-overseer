  ...
  render() {
    ...
    return (
      ...
      <div className={classes.root}>
        <HeaderBar open={this.state.open} handleDrawerOpen={this.handleDrawerOpen} toggleTheme={this.props.toggleTheme} headerContent={this.props.headerContent} changeRoom={this.props.changeRoom}/>
          <Drawer
            variant="permanent"
            classes={{
