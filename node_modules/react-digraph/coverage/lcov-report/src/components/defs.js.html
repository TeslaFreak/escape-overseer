...
<html lang="en">
<head>
    <title>Code coverage report for src/components/defs.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/components</a> defs.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  static processGraphConfigDefs(typesObj: any, graphConfigDefs: any) {
    Object.keys(typesObj).forEach((type) =&gt; {
      const safeId = typesObj[type].shapeId ? <span class="branch-0 cbranch-no" title="branch not covered" >typesObj[type].shapeId.replace('#', '') </span>: 'graphdef';
