...
<html lang="en">
<head>
    <title>Code coverage report for src/components/graph-controls.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/components</a> graph-controls.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  sliderToZoom(val: number) {
    ...
    return val * ((maxZoom || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> - (minZoom || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>) / steps + (minZoom || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>;
  }
&nbsp;
  // Convert zoom val (minZoom-maxZoom) to slider range
  zoomToSlider(val: number) {
    const { minZoom, maxZoom } = this.props;
    return (val - (minZoom || 0)) * steps / ((maxZoom || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> - (minZoom || 0));
  }
&nbsp;
...
&nbsp;
    if (zoomLevelNext &lt;= (maxZoom || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span> &amp;&amp; zoomLevelNext &gt;= (minZoom || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>) {
      ...
      &lt;div className="graph-controls"&gt;
        &lt;div className="slider-wrapper"&gt;
          ...
          &lt;input
            ...
            max={this.zoomToSlider(this.props.maxZoom || <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>}
