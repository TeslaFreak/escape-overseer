...
<html lang="en">
<head>
    <title>Code coverage report for src/utilities/layout-engine/layout-engine-config.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/utilities/layout-engine</a> layout-engine-config.js
    </h1>
    <div class='clearfix'>
