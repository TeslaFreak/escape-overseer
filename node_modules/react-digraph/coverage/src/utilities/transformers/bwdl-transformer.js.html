...
<span class="fstat-no" title="function not covered" >  st</span>atic transform(input: any) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    nodeNames.forEach(<span class="fstat-no" title="function not covered" >(n</span>ame) =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >      if (currentNode.Type === 'Choice') {</span>
        // multiple edges
<span class="cstat-no" title="statement not covered" >        currentNode.Choices.forEach(<span class="fstat-no" title="function not covered" >(c</span>hoice) =&gt; {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  st</span>atic revert(graphInput: IGraphInput) {
