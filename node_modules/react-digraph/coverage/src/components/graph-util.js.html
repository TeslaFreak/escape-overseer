...
<html lang="en">
<head>
    <title>Code coverage report for src/components/graph-util.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/components</a> graph-util.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  static getEdgesMap(arr: IEdge[]) {
    const map = {};
    arr.forEach((item, index) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!item.target) {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      map[`${item.source || <span class="branch-1 cbranch-no" title="branch not covered" >''}</span>_${item.target}`] = {
        edge: item,
        originalArrIndex: index
      };
    });
...
&nbsp;
  static linkNodesAndEdges(nodesMap: any, edges: IEdge[]) {
    edges.forEach((edge) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!edge.target) {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
      const nodeMapSourceNode = nodesMap[`key-${edge.source || <span class="branch-1 cbranch-no" title="branch not covered" >''}</span>`];
