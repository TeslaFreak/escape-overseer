...
class ClueConfigView extends Component {
    ...
    getClues = () => {
        return this.db.get(electron.remote.getGlobal('customerEmail') + '/' + this.props.selectedRoomId + '/roomClues').then(function(doc) {
    ...
    updateClueDoc = () => {
        this.db.get(electron.remote.getGlobal('customerEmail') + '/' + this.props.selectedRoomId + '/roomClues').then(function(doc) {
            ...
            this.db.put({
                _id: electron.remote.getGlobal('customerEmail') + '/' + this.props.selectedRoomId + '/roomClues',
