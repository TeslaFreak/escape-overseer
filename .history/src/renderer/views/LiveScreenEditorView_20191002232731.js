...
class LiveScreenEditorView extends Component {
    ...
    updateDimensions = () => {
        ...
        console.log('width:' + ((canvasContainer.clientWidth+140)/(editorContainer.clientWidth+appNavDrawer.clientWidth+140)) + 'height:' + (canvasContainer.clientHeight+200)/editorContainer.clientHeight);
        if(this.state.aspectDominantDimension=='width' && (canvasContainer.clientWidth+140)/(editorContainer.clientWidth+appNavDrawer.clientWidth+140) < (canvasContainer.clientHeight+200)/editorContainer.clientHeight) {
            console.log('flipped to height');
            this.setState({aspectDominantDimension:'height'})
            this.updateAspectRatio(this.state.aspectRatio);
        }
        else if(this.state.aspectDominantDimension=='height' && (canvasContainer.clientWidth+140)/(editorContainer.clientWidth+appNavDrawer.clientWidth+140) > (canvasContainer.clientHeight+200)/editorContainer.clientHeight) {
