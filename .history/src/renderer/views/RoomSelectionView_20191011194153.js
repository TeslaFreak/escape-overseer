...
class RoomSelectionView extends Component {  
  ...
  saveRoom = (name, id) => {
    ...
    this.db.get('rooms').then(function (doc) {
        ...
        let roomIndex = roomlist.findIndex((obj => obj._id == 3));
  ...
  openCardMenu = (e, id) => {
      e.stopPropagation();
      this.setState({roomIdToUpdate:id, changeNameModalOpen: true});
  }
  ...
  render() {
    ...
    return (
                    ...
                    <Card className={classes.card}>
                        <CardActionArea style={{width:'100%'}} onClick={() => this.props.changeRoom(room._id)} disableRipple>
                            ...
                            <CardContent style={{paddingTop:0, paddingBottom:0, paddingRight: 0}}>
                                <Grid container dir='row' justify='flexEnd' alignItems='center'>
                                    ...
                                    <Grid item>
                                        <IconButton onClick={e=>this.openCardMenu(e,room._id)}>
                                            <MoreVertIcon />
                                        </IconButton>
                                    </Grid>
                                </Grid>
        ...
        <ChangeRoomNameModal open={this.state.changeNameModalOpen} handleClose={this.closeModal} saveRoom={this.saveRoom} roomId={this.state.roomIdToUpdate}/>
        <DeleteRoomModal open={this.state.deleteRoomModalOpen} handleClose={this.closeModal} deleteRoom={this.deleteRoom} roomId={this.state.roomIdToUpdate}/>
        </React.Fragment>
    );
  }
}
