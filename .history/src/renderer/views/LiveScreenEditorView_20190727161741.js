    ...
    updateItemProperty = (propertyName, propertyValue) => {
        ...
        switch(propertyName) {
            ...
            case 'iconSpacing':
                ...
                var itemLen = this.state.selectedItem.iconSize;
                this.state.selectedItem.set(propertyName, propertyValue);
                this.state.selectedItem.forEachObject(function(obj, i) {
                    if(i == 0) {
                        ...
                        obj.set({ left: (propertyValue*i)+(itemLen*(i-1))})
                    }
                });
                
                this.state.selectedItem.set({
                    width: (propertyValue*this.state.selectedItem.numberOfClues-1)+(itemLen*this.state.selectedItem.numberOfClues)
                });
                break;
            case 'numberOfClues':
