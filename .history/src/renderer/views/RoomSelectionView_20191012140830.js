...
class RoomSelectionView extends Component {  
  ...
  openCardMenu = (e, id, name) => {
      e.stopPropagation();
      this.setState({roomIdToUpdate:id, roomNameToUpdate:name, changeNameModalOpen: true});
  }
                    ...
                    <Card className={classes.card}>
                        <CardActionArea style={{width:'100%'}} onClick={() => this.props.changeRoom(room._id)} disableRipple>
                            ...
                            <CardContent style={{paddingTop:0, paddingBottom:0, paddingRight: 0}}>
                                <Grid container dir='row' wrap='nowrap' justify='flexEnd' alignItems='center' style={{overflowWrap: 'break-word'}}>
                                    <Grid item overflow='hidden' style={{ paddingTop:16,paddingBottom:16, overflowWrap: 'break-word'}}>
                                        <Typography variant='h6' align='center' noWrap style={{overflowWrap: 'break-word'}}>
                                            {room.name}
                                        </Typography>
                                    </Grid>
                                    <Grid item >
