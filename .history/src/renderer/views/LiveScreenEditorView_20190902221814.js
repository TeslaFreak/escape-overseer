        ...
        switch(propertyName) {
            ...
            case 'aspectRatio':
                    ...
                    this.setState({ aspectWidth:`calc(${this.state.aspectDominantDimension=='width' ? containerWidth : containerHeight} * ${this.state.aspectDominantDimension!='width' ? 1 : AspectRatios.ratio16_9.height/AspectRatios.ratio16_9.width} )`,
                        aspectHeight: `calc(${this.state.aspectDominantDimension=='width' ? containerWidth : containerHeight} * ${this.state.aspectDominantDimension!='width' ? 1 : AspectRatios.ratio16_9.height/AspectRatios.ratio16_9.width} )`
                    });
