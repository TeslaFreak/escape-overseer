...
class LiveScreenEditorView extends Component {
    ...
    updateAspectRatio = (ratio) => {
        ...
        console.log(appNavDrawer.clientWidth);
        switch(ratio) {
            case '16:9':
    ...
    render() {
        ...
        return(
            <Grid id='editorContainer' container direction='row' justify='flex-end' alignItems='stretch' spacing={0} className={classes.editorContainer} style={{padding:1}}>
