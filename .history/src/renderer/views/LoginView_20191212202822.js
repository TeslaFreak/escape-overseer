...
export default function SignIn() {
  ...
  var userCredentials = {
    ...
    "host": "d0bbef17-7084-4e8a-8e9f-fbca21cb076a-bluemix.cloudantnosqldb.appdomain.cloud",
  ...
  const handleLoginAttempt = (e) => {
    ...
    if(navigator.onLine) {
        ...
        db.put({
            _id: 'demouser:testdoc',
            testprop: 'testtest123',
      }).then(function() {
        console.log('test doc saved');
