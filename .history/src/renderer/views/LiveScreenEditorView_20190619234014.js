    ...
    componentDidMount() {
        ...
        fabric.ClueTextbox = fabric.util.createClass(fabric.Textbox, {
            ...
            initialize: function(options) {
                ...
                this._dimensionAffectingProps= fabric.Text.prototype._dimensionAffectingProps;
            },
        });
    ...
    createNewCanvasItem = (itemType, event) => {
        switch(itemType) {
            ...
            case CanvasItemTypes.COUNTER:
                break;
            case CanvasItemTypes.CLUEDISPLAY:
                var newItem = new fabric.Textbox("Clue Text will appear here, with the same properties as this display text, bounded by this box... Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum eget mauris in eros efficitur sodales vel eu lectus. Curabitur dui felis, posuere non urna at, rhoncus efficitur ipsum.")
                newItem.set({
                    fontSize: 40,
