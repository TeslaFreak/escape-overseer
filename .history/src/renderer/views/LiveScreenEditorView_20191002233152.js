...
class LiveScreenEditorView extends Component {
    ...
    updateDimensions = () => {
        ...
        if(this.state.aspectDominantDimension=='width' && (canvasContainer.clientWidth+140)/(editorContainer.clientWidth+appNavDrawer.clientWidth) < ((canvasContainer.clientHeight+200)/editorContainer.clientHeight)+0.1) {
            console.log('flipped to height');
            this.setState({aspectDominantDimension:'height'})
            this.updateAspectRatio(this.state.aspectRatio);
        }
        else if(this.state.aspectDominantDimension=='height' && (((canvasContainer.clientWidth+140)/(editorContainer.clientWidth+appNavDrawer.clientWidth))+0.1) > (canvasContainer.clientHeight+200)/editorContainer.clientHeight) {
