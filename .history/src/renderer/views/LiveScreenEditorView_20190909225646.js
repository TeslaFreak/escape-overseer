    ...
    componentDidMount() {
        ...
        fabric.Timer = fabric.util.createClass(fabric.IText, {
            ...
            initialize: function(element, options) {
                ...
                this.set('fontSize', options.editable || 40);
                this.set('fontFamily', options.editable || 'Roboto');
                this.set('charSpacing', options.editable || 10);
                this.set('lockUniScaling', options.editable || true);
                this.set('lockScalingFlip', options.editable || true);
            },
        ...
        fabric.Timer.fromObject = function(object, callback, forceAsync) {
            callback && callback(new fabric.Timer(object.text, object));
        }
