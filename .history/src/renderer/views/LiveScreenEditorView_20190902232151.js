...
class LiveScreenEditorView extends Component {
    ...
    updateDimensions = () => {
        editorContainer = document.getElementById('canvasInteractionLayer');
        console.log('width:' + document.getElementById('canvasInteractionLayer').clientWidth + 'height:' + document.getElementById('canvasInteractionLayer').clientHeight);
