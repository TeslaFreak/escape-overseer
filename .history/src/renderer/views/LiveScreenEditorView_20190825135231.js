    ...
    renderEditPanels = (selectedPanel) => {
        switch(selectedPanel) {
            ...
            case EditPanelTypes.VISUALCOUNTER:
                return <VisualCounterEditPanel selectedItem={this.state.selectedItem} updateItemProperty={this.updateItemProperty} canvasObjectCount={this.canvas.size()} fileInputRef={this.state.fileInputRef}/>;
            ...
            case 'changeSrc':
                ...
                reader.onload = function (propertyValue) {
                    ...
                    imgObj.onload = function () {
                        ...
                        newItem.on('modified',  () => { 
                            this.updateSelectedItem(newItem, 'IMAGE');
                        });
                        newItem.on('selected', () => { 
                            this.updateSelectedItem(newItem, 'IMAGE');
                        });
