...
export default function SignIn() {
  ...
  const handleLoginAttempt = (e) => {
    ...
    if(navigator.onLine) {
        ...
        fetch('https://21731c69.us-south.apigw.appdomain.cloud/escapeoverseerAPI/verifyUserCredentials?email=' + email + '&password=' + password, {
                    method: 'POST',
                    headers: new Headers()
                }).then((res) => res.json())
                    .then((data) => console.log(data))
                    .catch((err) => console.log(err))
        /*fetch('https://21731c69.us-south.apigw.appdomain.cloud/escapeoverseerAPI/verifyUserCredentials', {
                    method: 'POST',
                    headers: new Headers(),
