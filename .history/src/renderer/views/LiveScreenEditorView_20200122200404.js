...
class LiveScreenEditorView extends Component {
    ...
    constructor(props) {
        ...
        console.log('email' + electron.remote.getGlobal('customerEmail'));
    }
    ...
    saveVideo = (videoFile) => {
        ...
        this.db.get(electron.remote.getGlobal('customerEmail') + '\\' + this.props.selectedRoomId + '\\breifVideo').then(function (doc) {
            this.db.remove(doc).then(function () {
                this.db.put({
                    _id: electron.remote.getGlobal('customerEmail') + '\\' + this.props.selectedRoomId + '\\breifVideo',
    ...
    saveImage = () => {
        ...
        this.db.get(electron.remote.getGlobal('customerEmail') + '/' + this.props.selectedRoomId + '/backgroundImg').then(function (doc) {
            this.db.remove(doc).then(function () {
                this.db.put({
                    _id: electron.remote.getGlobal('customerEmail') + '/' + this.props.selectedRoomId + '/backgroundImg',
                    customerId: electron.remote.getGlobal('customerId'),
                    _attachments: {
                        'backgroundImgFile': {
                        type: blob.type,
    ...
    saveJSON = async () => {
        ...
        this.db.get(electron.remote.getGlobal('customerEmail') + '/' + this.props.selectedRoomId + '/liveScreen').then(function (doc) {
            ...
            setTimeout(() => {
                ...
                if(err.name=="not_found") {
                    this.db.put({
                        _id: electron.remote.getGlobal('customerEmail') + '/' + this.props.selectedRoomId + '/liveScreen',
                        customerId: electron.remote.getGlobal('customerId'),
