    ...
    componentDidMount() {
        ...
        fabric.FittableImage = fabric.util.createClass(fabric.Image, {
            ...
            toObject: function() {
                return fabric.util.object.extend(this.callSuper('toObject'), {
                fit: this.get('fit'),
                selectable: this.get('lockMovementX'),
                selectable: this.get('lockMovementY'),
                selectable: this.get('lockScalingX'),
                selectable: this.get('lockScalingY'),
                selectable: this.get('lockRotation'),
                });
            },
        });
