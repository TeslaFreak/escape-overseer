...
class LiveScreenEditorView extends Component {
    ...
    updateAspectRatio = (ratio) => {
        ...
        switch(ratio) {
            case '16:9':
                this.setState({ aspectWidth:`calc(${this.state.aspectDominantDimension=='width' ? containerWidth - (appNavDrawer.clientWidth - 70) : containerHeight} * ${this.state.aspectDominantDimension=='width' ? 1 : AspectRatios.ratio16_9.width/AspectRatios.ratio16_9.height} )`,
                    aspectHeight: `calc(${this.state.aspectDominantDimension=='width' ? containerWidth - (appNavDrawer.clientWidth - 70) : containerHeight} * ${this.state.aspectDominantDimension=='width' ? AspectRatios.ratio16_9.height/AspectRatios.ratio16_9.width : 1} )`
                });
                this.canvas.setWidth(AspectRatios.ratio16_9.width) ;  
                this.canvas.setHeight(AspectRatios.ratio16_9.height);
                break;
            case '4:3':
                this.setState({ aspectWidth:`calc(${this.state.aspectDominantDimension=='width' ? containerWidth - (appNavDrawer.clientWidth - 70) : containerHeight} * ${this.state.aspectDominantDimension=='width' ? 1 : AspectRatios.ratio4_3.width/AspectRatios.ratio4_3.height} )`,
                    aspectHeight: `calc(${this.state.aspectDominantDimension=='width' ? containerWidth - (appNavDrawer.clientWidth - 70) : containerHeight} * ${this.state.aspectDominantDimension=='width' ? AspectRatios.ratio4_3.height/AspectRatios.ratio4_3.width : 1} )`
                });
                this.canvas.setWidth(AspectRatios.ratio4_3.width) ;  
                this.canvas.setHeight(AspectRatios.ratio4_3.height);
                break;
            case '1:1':
                this.setState({ aspectWidth:`calc(${this.state.aspectDominantDimension=='width' ? containerWidth - (appNavDrawer.clientWidth - 70) : containerHeight} * ${this.state.aspectDominantDimension=='width' ? 1 : AspectRatios.ratio1_1.width/AspectRatios.ratio1_1.height} )`,
                    aspectHeight: `calc(${this.state.aspectDominantDimension=='width' ? containerWidth - (appNavDrawer.clientWidth - 70) : containerHeight} * ${this.state.aspectDominantDimension=='width' ? AspectRatios.ratio1_1.height/AspectRatios.ratio1_1.width : 1} )`
                });
