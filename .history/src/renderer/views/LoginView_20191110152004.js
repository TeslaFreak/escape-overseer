...
class LiveScreen extends React.PureComponent {
  ...
  render() {
    ...
    electron.ipcRenderer.on('loginResponse', (event, status) => {
          ...
          <Grid container justify='center' alignItems='center' direction='column'>
            ...
            <Grid item>
                ...
                <OutlinedInput
                    ...
                    labelWidth={70}
                />
                {this.state.status != '' && <FormHelperText id="component-error-text">{this.state.status}</FormHelperText>}
                </FormControl>
            </Grid>
            <Grid item>
                <Button className={classNames(classes.margin)} fullWidth variant="contained" color="primary"
