    ...
    componentDidMount() {
        ...
        fabric.VisualCounter.fromObject = function(object, callback, forceAsync) {
            ...
            fabric.util.enlivenObjects(object.objects, function (enlivenedObjects) {
                ...
                fabric.Image.fromURL(object.unusedSource, function(imageobject) {
                    tmpObj = enlivenObjects[0].set({
                        usedType: 'unused',
                        visible: true
                    });
                    tmpObj.scaleToWidth(12);
                    group.push(tmpObj);
                    fabric.Image.fromURL(group.usedSource, function(imageobject) {
                        tmpObj = enlivenObjects[1].set({
                            usedType: 'used',
                            visible: false
                        });
                        tmpObj.scaleToWidth(12);
