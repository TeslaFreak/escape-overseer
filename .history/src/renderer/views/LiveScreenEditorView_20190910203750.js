    ...
    componentDidMount() {
        ...
        fabric.VisualCounter = fabric.util.createClass(fabric.Group, {
            ...
            initialize: function(group, options) {
                ...
                this.set('usedSource', options.numberOfClues || 'assets/images/ex-solid.png');
                this.set('lockUniScaling', options.numberOfClues || true);
            },
        ...
        fabric.VisualCounter.fromObject = function(object, callback, forceAsync) {
            console.log(object)
            let newItem = new fabric.VisualCounter(object);
            newItem.on('modified', () => {
