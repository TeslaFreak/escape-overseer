    ...
    createNewCanvasItem = (itemType, event) => {
        switch(itemType) {
            ...
            case CanvasItemTypes.COUNTER:
                    ...
                    fabric.Image.fromURL('https://github.com/google/material-design-icons/tree/master/action/png/production/ic_lock_48px.svg', function(img) {
                    var group2 = new fabric.Group([ circle1, circle2, img ], { left: 200, top: 200 });
