...
class RoomSelectionView extends Component {  
  ...
  render() {
    ...
    return (
        ...
        <CreateNewRoomModal open={this.state.newRoomModalOpen} handleClose={this.closeModal} saveNewRoom={this.saveNewRoom}/>
        <CreateNewRoomModal open={this.state.changeNameModalOpen} handleClose={this.closeModal} saveRoomName={this.saveRoomName}/>
        <CreateNewRoomModal open={this.state.deleteRoomModalOpen} handleClose={this.closeModal} deleteRoom={this.deleteRoom}/>
        </React.Fragment>
    );
  }
}
