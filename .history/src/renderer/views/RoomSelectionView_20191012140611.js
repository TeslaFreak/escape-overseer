                    ...
                    <Card className={classes.card}>
                        <CardActionArea style={{width:'100%'}} onClick={() => this.props.changeRoom(room._id)} disableRipple>
                            ...
                            <CardContent style={{paddingTop:0, paddingBottom:0, paddingRight: 0}}>
                                <Grid container dir='row' wrap='nowrap' justify='flexEnd' alignItems='center'  overflowWrap= 'break-word'>
                                    <Grid item overflow='hidden' style={{flexGrow:1, paddingTop:16,paddingBottom:16, overflowWrap: 'break-word'}}>
