        ...
        fabric.Timer = fabric.util.createClass(fabric.IText, {
            ...
            updateTimeDisplay: function() {
                ...
                if(this.showHours) {
                    ...
                    displayString += this.showMinutes ? `${substring}:` : `${substring}`;
                    remainingMinutes %= 60;
                }
                if(this.showMinutes) {
                    let totalMinutes = remainingMinutes;
                    let substring = totalMinutes.toString().padStart(2, '0');
                    displayString += this.showSeconds ? `${substring}:` : `${substring}`;
                ...
                if(this.showHours) {
                    ...
                    let substring = totalMilliseconds.toString().padStart(2, '0');
