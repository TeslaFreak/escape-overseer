...
class LiveScreenEditorView extends Component {
    ...
    updateDimensions = () => {
        ...
        else if(this.state.aspectDominantDimension=='height' && (((canvasContainer.clientWidth+140)/(editorContainer.clientWidth+appNavDrawer.clientWidth))-0.01) > (canvasContainer.clientHeight+200)/editorContainer.clientHeight) {
