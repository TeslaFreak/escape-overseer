    ...
    updateItemProperty = (propertyName, propertyValue) => {
        ...
        switch(propertyName) {
            ...
            case 'iconSpacing':
                ...
                this.state.selectedItem.set({originX: 'left'});
                this.state.selectedItem.set(propertyName, propertyValue);
                this.state.selectedItem.forEachObject(function(obj, i) {
                    if(i == 0) {
                        ...
                        //obj.set({ left: (propertyValue+iconSize)*i})
                    }
                });
                
                this.state.selectedItem.set({
                    width: (propertyValue*this.state.selectedItem.numberOfClues-1)+(iconSize*this.state.selectedItem.numberOfClues)
                });
                break;
            case 'numberOfClues':
