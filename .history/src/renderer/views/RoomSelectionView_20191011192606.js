...
import ChangeRoomNameModal from '../components/SaveRoomNameModal.js';
...
class RoomSelectionView extends Component {  
  ...
  openCardMenu = (e, id) => {
      e.stopPropagation();
      this.setState({changeNameModalOpen: true});
  }
  ...
  render() {
    ...
    return (
        ...
        <ChangeRoomNameModal open={this.state.changeNameModalOpen} handleClose={this.closeModal} saveRoom={this.saveRoom}/>
        <DeleteRoomModal open={this.state.deleteRoomModalOpen} handleClose={this.closeModal} deleteRoom={this.deleteRoom}/>
        </React.Fragment>
    );
  }
}
