  ...
  componentDidMount() {
    ...
    fabric.FittableImage.fromObject = function(object, callback, forceAsync) {
        ...
        imgObj.onload = function () {
            ...
            newItem.set({selectable: false, hoverCursor: 'auto'});
            callback && callback(newItem);
        }.bind(this);
    }.bind(this);
            ...
            var oldClueCount = this.numberOfClues;
                ...
                this.forEachObject(function(obj, i) {
                    if(i == 0 || i == 1) {
                        ...
                        if(i%2 == 0) {
                            obj.set({ left: -(groupWidth / 2) + (this.iconSpacing+this.iconSize)*(i/2)})
                        }
                        else{
                            obj.set({ left: -(groupWidth / 2) + (this.iconSpacing+this.iconSize)*((i/2)-0.5)})
                        }
    ...
    fabric.VisualCounter.fromObject = function(object, callback, forceAsync) {
        fabric.util.enlivenObjects(object.objects, function (enlivenedObjects) {
            ...
            newItem.set({selectable: false, hoverCursor: 'pointer'});
            newItem.updateNumerOfClues(object.numberOfClues);
