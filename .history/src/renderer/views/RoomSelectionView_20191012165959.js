  ...
  render() {
    ...
    return (
        ...
        <Popover 
            ...
            >
            <MenuList>
                <MenuItem onClick={this.setState({changeNameModalOpen:true})} align='start' size='small' >Change Room Name</MenuItem>
                <MenuItem onClick={this.setState({deleteRoomModalOpen:true})} align='start' size='small' >Delete Room</MenuItem>
            </MenuList>
        </Popover>
