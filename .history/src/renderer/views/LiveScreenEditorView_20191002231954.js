...
class LiveScreenEditorView extends Component {
    ...
    updateItemProperty = (propertyName, propertyValue) => {
        ...
        switch(propertyName) {
            ...
            case 'fontFamily':
                ...
                break;
            case 'aspectRatio':
                //TODO: loading mask on aspectRatio change
    ...
    updateAspectRatio = (ratio) => {
        ...
        let freshContainerWidth = `calc(100vw - 280px - 80px - 140px - ${appNavDrawer.clientWidth})`;
        switch(ratio) {
            case '16:9':
                this.setState({ aspectWidth:`calc(${this.state.aspectDominantDimension=='width' ? freshContainerWidth : containerHeight} * ${this.state.aspectDominantDimension=='width' ? 1 : AspectRatios.ratio16_9.width/AspectRatios.ratio16_9.height} )`,
                    aspectHeight: `calc(${this.state.aspectDominantDimension=='width' ? freshContainerWidth : containerHeight} * ${this.state.aspectDominantDimension=='width' ? AspectRatios.ratio16_9.height/AspectRatios.ratio16_9.width : 1} )`
                });
                this.canvas.setWidth(AspectRatios.ratio16_9.width) ;  
                this.canvas.setHeight(AspectRatios.ratio16_9.height);
                break;
            case '4:3':
                this.setState({ aspectWidth:`calc(${this.state.aspectDominantDimension=='width' ? freshContainerWidth : containerHeight} * ${this.state.aspectDominantDimension=='width' ? 1 : AspectRatios.ratio4_3.width/AspectRatios.ratio4_3.height} )`,
                    aspectHeight: `calc(${this.state.aspectDominantDimension=='width' ? freshContainerWidth : containerHeight} * ${this.state.aspectDominantDimension=='width' ? AspectRatios.ratio4_3.height/AspectRatios.ratio4_3.width : 1} )`
                });
                this.canvas.setWidth(AspectRatios.ratio4_3.width) ;  
                this.canvas.setHeight(AspectRatios.ratio4_3.height);
                break;
            case '1:1':
                this.setState({ aspectWidth:`calc(${this.state.aspectDominantDimension=='width' ? freshContainerWidth : containerHeight} * ${this.state.aspectDominantDimension=='width' ? 1 : AspectRatios.ratio1_1.width/AspectRatios.ratio1_1.height} )`,
                    aspectHeight: `calc(${this.state.aspectDominantDimension=='width' ? freshContainerWidth : containerHeight} * ${this.state.aspectDominantDimension=='width' ? AspectRatios.ratio1_1.height/AspectRatios.ratio1_1.width : 1} )`
                });
    ...
    updateDimensions = () => {
        ...
        if(this.state.aspectDominantDimension=='width' && (canvasContainer.clientWidth+140)/(editorContainer.clientWidth+appNavDrawer.clientWidth) < (canvasContainer.clientHeight+200)/editorContainer.clientHeight) {
    ...
    //TODO: add loading mask till finished
    loadJSON = async () => {
    ...
    //TODO: save aspect ratio information to canvas object. load in correct aspect ratio on load (use loading mask each time aspect ratio changes as well)
    //TODO: add actual save button or figure out best way to save.
    saveJSON = async () => {
