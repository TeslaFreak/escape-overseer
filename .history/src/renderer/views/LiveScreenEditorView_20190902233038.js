...
class LiveScreenEditorView extends Component {
    ...
    updateDimensions = () => {
        ...
        elseif(this.state.aspectDominantDimension=='height' && canvasContainer.clientWidth/editorContainer.clientWidth > canvasContainer.clientHeight/editorContainer.clientHeight) {
            console.log('flipped');
