    ...
    render() {
        ...
        return(
            <React.Fragment>
                ...
                <IconButton id="EditVideoButton" disableRipple className={this.state.selectedEditPanelType == this.props.EditPanelTypes.VIDEO ? classes.navPanelButtonSelected : classes.navPanelButton}>
                    <Grid container direction='column'>
                        <Grid item>
                            <VideoIcon/>
                        </Grid>
