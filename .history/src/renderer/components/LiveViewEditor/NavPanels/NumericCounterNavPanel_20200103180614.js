...
class CounterNavPanel extends Component {
    ...
    constructor(props) {
        super(props);
        this.state={selectedEditPanelType: this.props.EditPanelTypes.NUMERICCOUNTER};
        this.objects = [];
        ...
        return(
            <React.Fragment>
                <IconButton id="EditCounterButton" disableRipple 
                            className={this.state.selectedEditPanelType == this.props.EditPanelTypes.NUMERICCOUNTER ? classes.navPanelButtonSelected : classes.navPanelButton}
                            onClick={() => this.updateSelectedEditPanel(this.props.EditPanelTypes.NUMERICCOUNTER)}>
