    ...
    render() {
        ...
        return(
            <Grid container direction='column' >
                ...
                <Tooltip title="Note: this has no effect on the live view of the screen. This is only a toggle to allow you to see both states of the icon during editing." placement="right" classes={{ tooltip: classes.tooltipWidth }}>
