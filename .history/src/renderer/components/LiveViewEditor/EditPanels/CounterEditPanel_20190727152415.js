...
class ClueCountEditPanel extends Component {
    ...
    constructor(props) {
        ...
        this.state={iconSize: parseInt(this.props.selectedItem.iconSize**(1/1.7), 10),
                    iconSpacing: parseInt(this.props.selectedItem.iconSpacing**(1/1.7), 10)};
        this.objects = [];
    ...
    componentWillUpdate(nextProps) {
        ...
        if (this.state.iconSpacing !== parseInt(nextProps.selectedItem.iconSpacing**(1/1.7), 10) ) {
            this.setState({iconSpacing: parseInt(nextProps.selectedItem.iconSpacing**(1/1.7), 10)})
        }
