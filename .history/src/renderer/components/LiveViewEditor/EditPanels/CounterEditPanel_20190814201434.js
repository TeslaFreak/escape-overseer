    ...
    render() {
        ...
        return(
            <Grid container direction='column' >
                ...
                <Tooltip title="Note: this has no effect on the live view of the screen. This is only a toggle to allow you to see both states of the icon during editing." style={{tooltip: {maxWidth: 50}}} placement="right">
