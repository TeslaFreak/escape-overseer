...
class ClueCountEditPanel extends Component {
    ...
    constructor(props) {
        super(props);
        this.state={iconSize: parseInt(this.props.selectedItem.iconSize**(1/1.2), 10),
    ...
    componentWillUpdate(nextProps) {
        ...
        if (this.state.iconSize !== parseInt(nextProps.selectedItem.iconSize**(1/1.2), 10) ) {
            this.setState({iconSize: parseInt(nextProps.selectedItem.iconSize**(1/1.2), 10)})
        }
    }
