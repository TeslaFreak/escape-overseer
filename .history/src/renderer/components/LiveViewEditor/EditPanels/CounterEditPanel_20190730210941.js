...
class ClueCountEditPanel extends Component {
    ...
    componentWillUpdate(nextProps) {
        ...
        if (this.state.iconSpacing !== parseInt(nextProps.selectedItem.iconSpacing**(1/1.5), 10) ) {
            this.setState({iconSpacing: parseInt(nextProps.selectedItem.iconSpacing**(1/1.5), 10)})
        }
    ...
    handleChange = (event, value, propertyName) => {
        ...
        switch(propertyName) {
            case 'iconSize':
                ...
                break;
            case 'iconSpacing':
                roundedValue = parseInt(value, 10)**1.5;
                displayValue = parseInt(value, 10);
                break;
            default:
                roundedValue = value;
