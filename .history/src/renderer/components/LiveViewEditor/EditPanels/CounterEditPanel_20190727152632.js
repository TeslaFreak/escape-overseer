...
class ClueCountEditPanel extends Component {
    ...
    constructor(props) {
        ...
        this.state={iconSize: parseInt(this.props.selectedItem.iconSize**(1/1.7), 10),
                    iconSpacing: parseInt(this.props.selectedItem.iconSpacing**(1/2), 10)};
        this.objects = [];
    ...
    componentWillUpdate(nextProps) {
        ...
        if (this.state.iconSpacing !== parseInt(nextProps.selectedItem.iconSpacing**(1/2), 10) ) {
            this.setState({iconSpacing: parseInt(nextProps.selectedItem.iconSpacing**(1/2), 10)})
        }
    ...
    handleChange = (event, value, propertyName) => {
        ...
        switch(propertyName) {
            case 'iconSize':
                ...
                break;
            case 'iconSpacing':
                roundedValue = parseInt(value, 10)**2;
                displayValue = parseInt(value, 10);
                break;
            default:
                roundedValue = value;
