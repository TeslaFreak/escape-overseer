...
class ClueCountEditPanel extends Component {
    ...
    constructor(props) {
        super(props);
        this.state={iconSize: parseInt(this.props.selectedItem.getScaledWidth()**(1/1.7), 10),
    ...
    componentWillUpdate(nextProps) {
        ...
        if (this.state.iconSize !== parseInt(nextProps.selectedItem.getScaledWidth()**(1/1.7), 10) ) {
            this.setState({iconSize: parseInt(nextProps.selectedItem.getScaledWidth()**(1/1.7), 10)})
        }
    }
