...
class ClueCountEditPanel extends Component {
    ...
    constructor(props) {
        super(props);
        this.state={iconSize: this.props.selectedItem.iconSize,
                    iconSpacing: parseInt(this.props.selectedItem.iconSpacing**(1/0.7), 10)};
        this.objects = [];
    ...
    componentWillUpdate(nextProps) {
        ...
        if (this.state.iconSpacing !== parseInt(nextProps.selectedItem.iconSpacing**(1/0.7), 10) ) {
            this.setState({iconSpacing: parseInt(nextProps.selectedItem.iconSpacing**(1/0.7), 10)})
        }
    }
    ...
    handleChange = (event, value, propertyName) => {
        ...
        switch(propertyName) {
            case 'iconSpacing':
                roundedValue = parseInt(value, 10)**0.7;
