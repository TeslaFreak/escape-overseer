...
class ClueCountEditPanel extends Component {
    ...
    constructor(props) {
        super(props);
        this.state={iconSize: (parseInt(this.props.selectedItem.getScaledWidth()**(1/1.7), 10)-(this.props.selectedItem.iconSpacing*nextProps.selectedItem.numberOfClues-1))/this.props.selectedItem.numberOfClues,
