    ...
    render() {
        ...
        return(
            <Grid container direction='column' >
                ...
                <Typography className={classes.controlElementLabel}>Count Direction</Typography>
                <Grid item container direction='row' id='ButtonRow' className={classes.alignmentButtonRow}>
                    <Grid item>
                        <IconButton disableRipple className={classNames(classes.LeftRowButton, this.state.countDirection == 'down' ? classes.rowButtonSelected : '')} 
                                    onClick={(event) => this.handleChange(event, 'down', 'countDirection')}> 
                            Down
                        </IconButton>
                    </Grid>
                    <Grid item>
                        <IconButton disableRipple className={classNames(classes.RightRowButton, this.state.countDirection == 'up' ? classes.rowButtonSelected : '')} 
                                    onClick={(event) => this.handleChange(event, 'up', 'countDirection')}>
                            Up
                        </IconButton>
                    </Grid>
                </Grid>
