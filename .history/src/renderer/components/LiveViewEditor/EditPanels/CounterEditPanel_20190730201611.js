...
class ClueCountEditPanel extends Component {
    ...
    constructor(props) {
        super(props);
        this.state={iconSize: (parseInt(nextProps.selectedItem.getScaledWidth()**(1/1.7), 10)-(nextProps.selectedItem.iconSpacing*nextProps.selectedItem.numberOfClues-1))/nextProps.selectedItem.numberOfClues,
