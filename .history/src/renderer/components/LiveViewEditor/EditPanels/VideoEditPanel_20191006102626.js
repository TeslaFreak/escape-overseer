    ...
    render() {
        ...
        return(
            <Grid container direction='column' >
                ...
                <Grid item >
                    <Typography className={classes.controlElementLabel}>Currently Selected Video: </Typography>
                    <Typography className={classes.controlElementLabel}>/t{this.props.savedVideoName}</Typography>
                </Grid>
                <Grid item >
