        ...
        return(
            <Grid container direction='column' >
                ...
                <Grid item container direction='row' id='ButtonRow' className={classes.alignmentButtonRow}>
                    <Grid item>
                        <IconButton disableRipple className={classNames(classes.LeftRowButton, this.state.counterType == 'visual' ? classes.rowButtonSelected : '')} 
                                    onClick={(event) => this.handleChange(event, 'visual', 'counterType')}> 
                            Visual
                        </IconButton>
                    </Grid>
                    <Grid item>
                        <IconButton disableRipple className={classNames(classes.RightRowButton, this.state.counterType == 'numeric' ? classes.rowButtonSelected : '')} 
                                    onClick={(event) => this.handleChange(event, 'numeric', 'counterType')}>
                            Numeric
                        </IconButton>
                    </Grid>
                </Grid>
                <Tooltip title="Note: this has no effect on the live view of the screen. This is only a toggle to allow you to see both states of the icon during editing." placement="bottom" classes={{ tooltip: classes.tooltipWidth }}>
                    <Typography className={classes.controlElementLabel}>Icon Status</Typography>
                </Tooltip>
                <Grid item container direction='row' id='ButtonRow' className={classes.alignmentButtonRow}>
                    <Grid item>
                        <IconButton disableRipple className={classNames(classes.LeftRowButton, this.state.counterType == 'unused' ? classes.rowButtonSelected : '')} 
                                    onClick={(event) => this.handleChange(event, 'unused', 'usedStatus')}> 
                            Unused
                        </IconButton>
                    </Grid>
                    <Grid item>
                        <IconButton disableRipple className={classNames(classes.RightRowButton, this.state.counterType == 'used' ? classes.rowButtonSelected : '')} 
