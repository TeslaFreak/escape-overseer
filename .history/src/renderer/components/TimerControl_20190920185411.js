...
class TimerControl extends React.Component{
  constructor(props) {
    super(props);
    this.state = {startingMinutes: this.props.totalTime,
                  minutes: this.props.totalTime,
                  seconds: 0,
                  paused: true,
                  timeToAdjust: 0};
  ...
  resetTimer = () => {
    this.setState({paused: true, minutes: this.state.startingMinutes, seconds:0, timeToAdjust: 0});
  }
