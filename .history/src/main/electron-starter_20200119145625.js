...
function createLoginWindow() {
    ...
    loginWindow = new BrowserWindow({width: 475,
                                     ...
                                     resizable: true, 
                                     title: "Escape Overseer",
                                     icon:'public/assets/images/icons/logo64.ico',
                                     // Remove the window frame from windows applications
                                     frame: false,
                                     // Hide the titlebar from MacOS applications while keeping the stop lights
                                     titleBarStyle: 'hidden', // or 'customButtonsOnHover',
...
app.on('ready', function() {
    //let trayIcon = nativeImage.createFromPath('/favicon.png');
    //trayIcon = trayIcon.resize({ width: 16, height: 16 });
    let appIcon = new Tray('public/assets/images/icons/logo64.ico')
