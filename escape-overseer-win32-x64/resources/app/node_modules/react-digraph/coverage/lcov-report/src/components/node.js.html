...
<html lang="en">
<head>
    <title>Code coverage report for src/components/node.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/components</a> node.js
    </h1>
    <div class='clearfix'>
...
class Node extends React.Component&lt;INodeProps, INodeState&gt; {
  static defaultProps = {
    isSelected: false,
    nodeSize: 154,
    onNodeMouseEnter: <span class="fstat-no" title="function not covered" >()</span> =&gt; { <span class="cstat-no" title="statement not covered" >return; </span>},
    onNodeMouseLeave: <span class="fstat-no" title="function not covered" >()</span> =&gt; { <span class="cstat-no" title="statement not covered" >return; </span>},
    onNodeMove: <span class="fstat-no" title="function not covered" >()</span> =&gt; { <span class="cstat-no" title="statement not covered" >return; </span>},
    onNodeSelected: <span class="fstat-no" title="function not covered" >()</span> =&gt; { <span class="cstat-no" title="statement not covered" >return; </span>},
    onNodeUpdate: <span class="fstat-no" title="function not covered" >()</span> =&gt; { <span class="cstat-no" title="statement not covered" >return; </span>}
  };
&nbsp;
  static getDerivedStateFromProps(nextProps: INodeProps, prevState: INodeState) {
    return {
      selected: nextProps.isSelected,
      x: nextProps.data.x || <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
      y: nextProps.data.y || <span class="branch-1 cbranch-no" title="branch not covered" >0</span>
    };
  }
&nbsp;
  nodeRef: any;
...
&nbsp;
    this.state = {
      ...
      mouseDown: false,
      selected: false,
      x: props.data.x || <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
      y: props.data.y || <span class="branch-1 cbranch-no" title="branch not covered" >0</span>
    };
&nbsp;
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if(!this.state.drawingEdge) {
      // move node
      if (layoutEngine) {
...
&nbsp;
  handleDragStart = () =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.nodeRef.current) {
...
&nbsp;
  renderShape() {
    ...
    const props = {
      height: this.props.nodeSize || <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
      width: this.props.nodeSize || <span class="branch-1 cbranch-no" title="branch not covered" >0</span>
    };
    ...
    const nodeTypeXlinkHref = Node.getNodeTypeXlinkHref(data, nodeTypes) || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
    const nodeSubtypeXlinkHref = Node.getNodeSubtypeXlinkHref(data, nodeSubtypes) || '';
&nbsp;
    // get width and height defined on def element
    const defSvgNodeElement: any = nodeTypeXlinkHref ? document.querySelector(`defs&gt;${nodeTypeXlinkHref}`) : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
    const nodeWidthAttr = defSvgNodeElement ? defSvgNodeElement.getAttribute('width') : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
    const nodeHeightAttr = defSvgNodeElement ? defSvgNodeElement.getAttribute('height') : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
    props.width = nodeWidthAttr ? parseInt(nodeWidthAttr, 10) : <span class="branch-1 cbranch-no" title="branch not covered" >props.width;</span>
    props.height = nodeHeightAttr ? parseInt(nodeHeightAttr, 10) : <span class="branch-1 cbranch-no" title="branch not covered" >props.height;</span>
&nbsp;
    if (renderNode) {
